                ...
                <Container>
                    <Row className=' align-items-center my-5'>
                        <Col lg={6} className='text-center text-lg-start mb-5 mb-lg-0'>
                            ...
                            <h2>Save Upto 20%</h2>
                            <p>
                                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sapiente deleniti suscipit voluptatum? Harum, repellat. Officia, quae. Delectus, at!
                            </p>
                        ...
                        <Col lg={6}>
                            <img src={DownloadImage}alt="e-shop"  width="600"className='im-fluid e_shop' />
                        </Col>
